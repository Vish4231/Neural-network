...
if __name__ == "__main__":
    qual_averages = [
        ...
        ("Lando Norris", 3.50),
        ("George Russell", 4.33),
        ("Charles Leclerc", 5.67),
        ("Lewis Hamilton", 7.00),
        ("Andrea Kimi Antonelli", 8.00),
        ("Isack Hadjar", 10.08),
        ("Alexander Albon", 10.17),
        ("Fernando Alonso", 10.75),
        ("Carlos Sainz", 11.58),
        ("Pierre Gasly", 12.00),
        ("Yuki Tsunoda", 12.50),
        ("Liam Lawson", 14.58),
        ("Esteban Ocon", 15.00),
        ("Gabriel Bortoleto", 15.42),
        ("Jack Doohan", 15.50),
        ("Oliver Bearman", 15.83),
        ("Nico Hulkenberg", 16.08),
        ("Lance Stroll", 16.17),
        ("Franco Colapinto", 21.00),
    ]
